      ...
      <section className={classes.projectSection}>
        <div className={classes.mainContainer}>
          <div className={classes.projectTextAndImageContainer}>
            ...
            >
              <Image
                ...
                src={mobileOne}
                alt="Inputs for currency and amounts"
              />
            </motion.div>
          </div>
          <motion.div
          ...
          >
            ...
            >
              <Link
                href="https://xchange-cavey-app.netlify.app/"
                target="_blank"
              >
                Site
              </Link>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        >
          ...
          <Button
            ...
            className={classes.projectButton}
          >
            <Link href="https://xchange-cavey-app.netlify.app/" target="_blank">
              Site
            </Link>
          </Button>
        </Modal.Footer>
